		...
		try {
			...
			if (msg.type() == MsgType.AE_REQUEST){
				...
				while (msg.type() == MsgType.OPERATION){
					...
					if(msgOperation.getOperation().getType() == OperationType.ADD) {
						AddOperation addOp = (AddOperation) msgOperation.getOperation();
						serverData.addRecipe(addOp.getRecipe().getTitle(), addOp.getRecipe().getRecipe());
					}
					msg = (Message) in.readObject();
